...
Puppeteer end-to-end test automation boilerplate, Using [Commonjs](https://requirejs.org/docs/commonjs.html), [Jest](https://jestjs.io) and [Commonjs](https://nodejs.org/api/assert.html).
